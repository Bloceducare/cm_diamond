export const OrganisationABI = [
  ...
  { inputs: [], name: "ATTENDANCE_ALREADY_CLOSED", type: "error" },
  { inputs: [], name: "ATTENDANCE_ALREADY_OPEN", type: "error" },
  { inputs: [], name: "ATTENDANCE_COMPILATION_STARTED", type: "error" },
  { inputs: [], name: "CERTIFICATE_ALREADY_ISSUED", type: "error" },
  { inputs: [], name: "INVALID_LECTURE_ID", type: "error" },
  { inputs: [], name: "INVALID_MENTOR_ADDRESS", type: "error" },
  { inputs: [], name: "INVALID_STUDENT_ADDRESS", type: "error" },
  { inputs: [], name: "LECTURE_ID_ALREADY_USED", type: "error" },
  { inputs: [], name: "LECTURE_ID_CLOSED", type: "error" },
  { inputs: [], name: "NOT_ALLOWED_TO_REQUEST_A_NAME_CHANGE", type: "error" },
  { inputs: [], name: "NOT_A_MENTOR", type: "error" },
  { inputs: [], name: "NOT_A_STUDENT", type: "error" },
  { inputs: [], name: "NOT_A_VALID_MODERATOR", type: "error" },
  { inputs: [], name: "NOT_A_VALID_STUDENT", type: "error" },
  { inputs: [], name: "SPOK_ALREADY_MINTED", type: "error" },
  { inputs: [], name: "TEST_ID_ALREADY_USED", type: "error" },
  { inputs: [], name: "THREAT_DETECTED", type: "error" },
  { inputs: [], name: "UNAUTHORIZED_CALLER", type: "error" },
  {
    anonymous: false,
    inputs: [
  ...
  {
    inputs: [
      { internalType: "address", name: "_menotorOnDuty", type: "address" },
      { internalType: "bytes", name: "_lectureId", type: "bytes" },
    ],
    name: "closeAttendanceGasless",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
    ...
    outputs: [
      {
        ...
        internalType: "struct LibOrganisation.lectureData",
        name: "",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_menotorsAddress", type: "address" },
      { internalType: "string", name: "Uri", type: "string" },
    ],
