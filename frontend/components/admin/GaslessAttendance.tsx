...
import useOpenGaslessAttendance from "@/hooks/adminHooks/useOpenGaslessAttendance";
import useCloseGaslessAttendance from "@/hooks/adminHooks/useCloseGaslessAttendance";
...
import useCreateGaslessAttendance from "@/hooks/adminHooks/useCreateGaslessAttendance";

const AttendenceNFT = ({ apiKey, secretKey }: any) => {
  const [lectureInfo, setLectureInfo] = useState<any[]>([]);
  const [isLoading, setIsLoading] = useState<boolean>(true);
  const { address: mentorAddress } = useAccount();
  ...
  const { createGaslessAttendance, isConfirming, isConfirmed } =
    useCreateGaslessAttendance(lectureId, imageUri, topic, mentorAddress);
          ...
          <div className="flex flex-col ">
            ...
            <div className="w-full flex flex-col mt-4 text-red-600">
              ...
              <ol className="list-decimal list-inside text-xs text-red-600">
                <li>
                  Click on the 'Create new attendance' button to create a new
                  attendance.
                </li>
                <li>
                  Select image, enter the topic and lectureId for the
                  attendance.
                </li>
